...
//Add a new route to handle rating submission
// app.post('/myprofile/rating', async function(req, res){
//     try
//     {
//         conn = await client.connect();
//         db = conn.db('MSWD');
...
//         // Assuming the rating is sent in the request body
//         const { rating } = req.body;

//         // Check if rating is within range (0-5)
//         if (rating < 0 || rating > 5) {
//             return res.json("Rating should be between 0 and 5").status(400);
//         }
...
app.post('/sendemail', async function(req, res){
    try
    {
        var transport = nodemailer.createTransport({
            ...
            port: 445,
            secure: true,
            auth:{user: "lvskarthik123@gmail.com", pass: "upifmbyvjqooykmb"}
        });

        var emaildata = {
            from: "lvskarthik123@gmail.com",
            to:"lvskarthik123@gmail.com",
